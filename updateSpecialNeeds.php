  ...
  <section id="content">
    ...
    <div class="content">
      <div class="content-header">
        <h1>Update Special Needs</h1>
        <p>Update Special Needs data in this page</p>
        <br>

      </div>
      <?php
                $schoolName = $_GET['schoolName'];
                $query = "SELECT * FROM special_needs_facilities WHERE school_school_name = '$schoolName'";
        ...
        <div class="content-body">
          <div class="form-style-2">
            <div class="form-style-2-heading">Fill up the updated Special Needs information</div>
            <form action="doUpdateSpecialNeeds.php" method="post">
              <label for="school_name"><span>School Name</span><select name="school_name" class="select-field">
                ...
                <?php
                                    $query = "SELECT school_name FROM school WHERE NOT school_name='" . $row1['school_school_name'] . "' ORDER BY school_name ASC";
                                    $result = $mysqli->query($query);
              ...
              <label for="option_code"><span>Option Code <span class="required">*</span></span><input type="text" class="input-field" name="option_code" value="<?php echo $row1['option_code'] ?>" /></label>
